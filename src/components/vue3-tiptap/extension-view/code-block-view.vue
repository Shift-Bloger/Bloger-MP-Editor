<template>
	...
	<node-view-wrapper as="section" class="code-block" style="background-color: #282c34; border-radius: 8px; margin: 15px 0; overflow: hidden; font-family: Consolas, Monaco, 'Andale Mono', 'Ubuntu Mono', monospace;">
		<section class="mac-header" style="height: 50px; line-height: 30px; padding: 10px 16px; background-color: #21252b; display: block;">
		...
		<pre :class="'code-snippet code-snippet_nowrap'" :data-lang="selectedLanguage" style="padding: 16px; margin: 0; overflow-x: auto; color: #abb2bf; font-size: 14px; line-height: 1.6; display: block; white-space: pre; background: #282c34;"><code><node-view-content /></code></pre>
	</node-view-wrapper>
</template>
...
const languages = ref(['html', 'css', 'javascript', 'java', 'python', 'php', 'typescript', 'json', 'scss', 'sql', 'apache', 'nginx', 'vue', 'bash']);
